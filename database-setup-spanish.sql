...
-- Enhanced Database Setup with New Tables for Spanish Taller Mecánico Website
-- Run this in your Supabase SQL Editor
...
('Taller Mecánico', 'Interior de nuestro taller mecánico profesional.', 'photo', '/images/gallery/taller-interior.jpg', '/images/gallery/taller-interior-thumb.jpg', 'Taller', 'taller,mecanico,autos', true),
('Cambio de Aceite', 'Mecánico realizando un cambio de aceite.', 'photo', '/images/gallery/cambio-aceite.jpg', '/images/gallery/cambio-aceite-thumb.jpg', 'Servicios', 'aceite,cambio,motor', true),
('Alineación de Ruedas', 'Equipo de alineación computarizada en acción.', 'photo', '/images/gallery/alineacion.jpg', '/images/gallery/alineacion-thumb.jpg', 'Servicios', 'alineacion,ruedas,balanceo', true),
('Diagnóstico Electrónico', 'Mecánico utilizando un escaner de diagnóstico.', 'photo', '/images/gallery/diagnostico.jpg', '/images/gallery/diagnostico-thumb.jpg', 'Servicios', 'diagnostico,escaner,electronica', true)
ON CONFLICT (id) DO NOTHING;
