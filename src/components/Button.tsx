...
export function Button({
  ...
  const variants = {
    primary: 'bg-accent-600 text-white hover:bg-accent-700 focus:ring-accent-500 shadow-tool hover:shadow-tool active:shadow-pressed hover:-translate-y-0.5 active:translate-y-0',
