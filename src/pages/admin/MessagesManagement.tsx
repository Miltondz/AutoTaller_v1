...
import { Mail, User, Phone, MessageSquare, Clock, CheckCircle, XCircle, AlertCircle, Trash2, Reply, Send, Filter, Download } from 'lucide-react';
...
function MessagesManagement() {
  ...
  const getInquiryTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'eventos': return 'bg-secondary-100 text-secondary-800';
